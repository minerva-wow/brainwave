    ...
    <Section crosses>
      <div className="container lg:flex">
        ...
        <div className="lg:ml-auto xl:w-[38rem] mt-4">
            ...
            <div className="relative left-1/2 -translate-x-1/2 flex w-[22rem] aspect-square border
                            border-n-6 rounded-full  scale-75
                            md:scale-100">
                ...
                {collabApps.map((app,index)=>(
                  <li key={app.id} className={`absolute top-0 left-1/2 h-1/2 -ml-[1.6rem] 
                    ...
                    <div className={`relative -top-[1.6rem] flex w-[3.2rem] h-[3.2rem] bg-n-7
                      ...
                      <img src={app.icon} className="m-auto" width={app.width}
                          height={app.height} alt={app.title} />
                    </div>
                  </li>
                ))}
              </ul>
