        ...
        <div className="relative">
          <div className="relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-n-1/10
            ...
            <div className="relative z-1 max-w-[17rem] ml-auto">
              <h4 className="h4 mb-4">Smartiest AI</h4>
            ...
            <Generating className="absolute left-4 right-4 bottom-4 border-n-1/10 border 
          ...
          <div className="relative z-1 grid gap-5 lg:grid-cols-2">
            ...
            <div className="p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem]">
              <div className="py-12 px-4 xl:px-8">
                ...
                <ul className="flex items-center justify-between">
                  {brainwaveServicesIcons.map((item, index) => (
                    <li key={index} className={`flex rounded-2xl items-center justify-center ${index === 2? 
                    'w-[3rem] h-[3rem] p-0.25 bg-conic-gradient md:w-[4.5rem] md:h-[4.5rem] ':'w-10 h-10 bg-n-6 md:w-15 md:h-15'}`}>
              ...
              <div className="relative h-[20rem] bg-n-8 rounded-xl overflow-hidden md:h-[25rem]">
                <img src={service3} className="w-full h-full object-cover" width={520} height={400} 
                      alt="Scary robot" />
                <VideoChatMessage />
                <VideoBar />
              </div>
