...
const Hero = () => {
  ...
  return (
    <Section className='pt-[12rem] -mt-[5.5rem]' crosses crossesOffset='lg:translate-y-[5.25rem]'
      ...
      <div className="container relative" ref={parallaxRef}>
        <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[4rem] 
          ...
          <p className="body-1 max-3-xl mx-auto mb-6 text-n-2 lg:mb-8">
        ...
        <div className="relative max-w-[23rem] mx-auto md:max-w-5xl xl:mb-24">
          <div className="relative z-1 p-0.5 rounded-2xl bg-conic-gradient">
            <div className="relative bg-n-8 rounded-[1rem]">
              ...
              <div className="aspect-[33/40] rounded-b-[0.9rem] overflow-hidden
                ...
                <img src={robot} className="w-full scale-[1.7] translate-y-[8%] md:scale-[1] md:-translate-y-[10%]
                lg:-translate-y-[23%]" width={1024} height={490} alt="AI" />
                ...
                <ScrollParallax isAbsolutelyPositioned>
                  <ul className="hidden absolute -left-[5.5rem] bottom-[7.5rem] px-1 py-1 bg-n-9/40
          ...
          <div className="absolute -top-[60%] left-1/2 w-[234%] -translate-x-1/2
                md:-top-[50%] md:w-[138%] lg:-top-[100%]">
